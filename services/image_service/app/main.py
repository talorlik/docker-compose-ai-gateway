"""Image service - backend for image intents (FR-011, FR-067)."""
...
logger = setup_logging("image-service", os.environ.get("LOG_LEVEL", "INFO"))
...
async def handle(req: HandleRequest):
    """Handle image intent: simulated image-handling payload and trace entry."""
    logger.info(
        "handle request",
    ...
    payload = {
        ...
        "result": f"Image processing for: {req.text}",
        "instance": instance,
        "detected_labels": ["photo", "document", "graphic"],
