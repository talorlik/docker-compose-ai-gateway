...
| FR-016 | The gateway SHALL evaluate a configurable confidence threshold (`T_route`; runtime default value 0.60 from generated env config, code fallback 0.55). | Must |
...
| FR-026 | The gateway SHALL use a configurable confidence threshold (`T_route`; runtime default value 0.60 from generated env config, code fallback 0.55) for non-unknown routes. | Must |
