...
- `REFINE_RELABEL_WORKERS=1`
- `REFINE_AUGMENT_WORKERS=1`
- `REFINE_RELABEL_NUM_CTX=1024`
- `REFINE_AUGMENT_NUM_CTX=768`
- `REFINE_RELABEL_NUM_PREDICT=120`
- `REFINE_AUGMENT_NUM_PREDICT=180`
- `REFINE_TEMPERATURE=0.1`
- `REFINE_SEED=42`
- `REFINE_STRUCTURED_OUTPUT_ENABLED=true`
...
- `REFINE_RELABEL_WORKERS`
- `REFINE_AUGMENT_WORKERS`
- `REFINE_RELABEL_NUM_CTX`
- `REFINE_AUGMENT_NUM_CTX`
- `REFINE_RELABEL_NUM_PREDICT`
- `REFINE_AUGMENT_NUM_PREDICT`
- `REFINE_TEMPERATURE`
- `REFINE_SEED`
- `REFINE_STRUCTURED_OUTPUT_ENABLED`
- existing `REFINER_*` knobs (batch/parallel/limits/retries)
