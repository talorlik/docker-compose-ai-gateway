...
| 4.3 | Gateway: add configurable confidence threshold (runtime default `T_route=0.60` from generated env config; code fallback `0.55`). If route is `unknown` or confidence &lt; threshold, return 404-equivalent with `request_id`, `route`, `confidence`, `message`, `trace` (no backend call). | FR-006, FR-016, FR-017, FR-026, FR-028, FR-037 | TECH-5, TECH-6, TECH-9, TECH-14.4, TECH-19.1 | x |
